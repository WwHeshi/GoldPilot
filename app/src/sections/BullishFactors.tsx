...
const defaultFactors: BullishFactor[] = [
  {
    ...
    title: '美联储降息周期',
    subtitle: '货币政策转向宽松',
    description: '市场持续关注美联储政策转向和实际利率变化。若降息预期升温或实际利率回落，黄金作为非孳息资产的配置吸引力会增强。',
    details: [
      '降息预期升温会降低持有黄金的机会成本',
      '实际利率下行降低持有黄金的机会成本',
      '政策不确定性会提升避险资产配置需求',
              ...
              <div className="card-glass rounded-xl p-4 border border-gray-700/50 shadow-2xl">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div className="flex gap-2">
                    ...
                    <span className="text-gray-300">ReAct推理架构 + 可选实时搜索</span>
                  </div>
                  <div className="flex gap-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <span className="text-gray-300">可选模型实时搜索 + 行情API + MySQL历史数据</span>
                  </div>
                </div>
                {/* Arrow */}
